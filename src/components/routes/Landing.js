      ...
      <div className="landing">
        <header className="landing__header">
          <nav>
            ...
            <ul className="landing__auth">
              <li className='landing__auth-login'>
                <div
                  tabIndex='0'
              ...
              <li className='landing__auth-signin'>
                <div
                  tabIndex='0'
